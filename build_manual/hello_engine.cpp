...
static ModelError_t addTensor_w_qkv(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_w_qkv[] = {16, 16};
...
static ModelError_t addTensor_w_ffn1(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_w_ffn1[] = {64, 16};
...
static ModelError_t addTensor_w_ffn2(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;
  uint32_t dimensions_w_ffn2[] = {16, 64};
...
static ModelError_t addNode_node_matmul(QnnModel& model){
  ...
  uint32_t dimensions_matmul[] = {12, 16};
...
static ModelError_t addNode_node_matmul_2(QnnModel& model){
  ...
  uint32_t dimensions_matmul_2[] = {12, 16};
...
static ModelError_t addNode_node_matmul_3(QnnModel& model){
  ...
  uint32_t dimensions_matmul_3[] = {12, 64};
...
static ModelError_t addNode_node_relu(QnnModel& model){
  ...
  uint32_t dimensions_relu[] = {12, 64};
...
static ModelError_t addNode_node_matmul_4(QnnModel& model){
  ...
  uint32_t dimensions_prediction[] = {12, 16};
...
static ModelError_t addNode_node_matmul_5(QnnModel& model){
  ...
  uint32_t dimensions_grad_ffn2[] = {16, 64};
...
static ModelError_t addNode_node_matmul_6(QnnModel& model){
  ...
  uint32_t dimensions_matmul_6[] = {12, 64};
...
static ModelError_t addNode_node_index_put(QnnModel& model){
  ...
  uint32_t dimensions_index_put[] = {12, 64};
...
static ModelError_t addNode_node_matmul_7(QnnModel& model){
  ...
  uint32_t dimensions_grad_ffn1[] = {64, 16};
...
static ModelError_t addNode_node_matmul_8(QnnModel& model){
  ...
  uint32_t dimensions_grad_qkv[] = {16, 16};
...
ModelError_t QnnModel_composeGraphs(Qnn_BackendHandle_t backendHandle,
  ...
  /* model/graph for qnn_hello_model*/
  QnnModel qnn_hello_model;
  const QnnGraph_Config_t** graphConfigs = nullptr;
  VALIDATE(getQnnGraphConfigFromInfo("qnn_hello_model", graphsConfigInfo, numGraphsConfigInfo, graphConfigs), err);
  VALIDATE(qnn_hello_model.initialize(backendHandle, interface, contextHandle, "qnn_hello_model", debug, DO_GRAPH_NODE_VALIDATIONS, graphConfigs), err);
  VALIDATE(addTensor_src(qnn_hello_model), err);
  VALIDATE(addTensor_tgt(qnn_hello_model), err);
  VALIDATE(addTensor_w_qkv(qnn_hello_model), err);
  VALIDATE(addTensor_w_ffn1(qnn_hello_model), err);
  VALIDATE(addTensor_w_ffn2(qnn_hello_model), err);
  VALIDATE(addNode_node_t(qnn_hello_model), err);
  VALIDATE(addNode_node_matmul(qnn_hello_model), err);
  VALIDATE(addNode_node_t_1(qnn_hello_model), err);
  VALIDATE(addNode_node_matmul_1(qnn_hello_model), err);
  VALIDATE(addTensor_val_0(qnn_hello_model), err);
  VALIDATE(addNode_node_div(qnn_hello_model), err);
  VALIDATE(addNode_node_softmax(qnn_hello_model), err);
  VALIDATE(addNode_node_matmul_2(qnn_hello_model), err);
  VALIDATE(addNode_node_t_2(qnn_hello_model), err);
  VALIDATE(addNode_node_matmul_3(qnn_hello_model), err);
  VALIDATE(addNode_node_relu(qnn_hello_model), err);
  VALIDATE(addNode_node_t_3(qnn_hello_model), err);
  VALIDATE(addNode_node_matmul_4(qnn_hello_model), err);
  VALIDATE(addNode_node_sub(qnn_hello_model), err);
  VALIDATE(addNode_node_t_4(qnn_hello_model), err);
  VALIDATE(addNode_node_matmul_5(qnn_hello_model), err);
  VALIDATE(addNode_node_matmul_6(qnn_hello_model), err);
  VALIDATE(addTensor_scalar_tensor_default(qnn_hello_model), err);
  VALIDATE(addNode_node_le(qnn_hello_model), err);
  VALIDATE(addNode_node_index_put(qnn_hello_model), err);
  VALIDATE(addNode_node_t_6(qnn_hello_model), err);
  VALIDATE(addNode_node_matmul_7(qnn_hello_model), err);
  VALIDATE(addNode_node_matmul_8(qnn_hello_model), err);

  // Add all models to array to get graphsInfo
  QnnModel* models [] = {&qnn_hello_model};
