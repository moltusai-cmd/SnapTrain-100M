...
static ModelError_t addNode_node_t_8(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR node_t_8 */
  uint32_t dimensions_node_t_8_perm[] = {2};
  uint32_t node_t_8_perm[] = {1, 0};
  Qnn_Param_t params_node_t_8[] = {
    {.paramType=QNN_PARAMTYPE_TENSOR,
     .name="perm",
     {.tensorParam=(Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            ...
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 1,
            .dimensions=dimensions_node_t_8_perm,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=(uint8_t*)node_t_8_perm,
                           .dataSize=8}},
            .isDynamicDimensions= nullptr,
            .sparseParams= { QNN_SPARSE_LAYOUT_UNDEFINED,
                             .hybridCoo= {.numSpecifiedElements= 0, .numSparseDimensions= 0}},
  ...
  const char*  inputs_node_t_8[] = {
    "sub"
  };
  uint32_t dimensions_t_8[] = {512, 64};
  Qnn_Tensor_t outputs_node_t_8[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         ...
                         "qti.aisw", // Package Name
                         "Transpose", // Qnn Node Type
                         params_node_t_8, // Node Params
                         1, // Num Node Params
                         inputs_node_t_8, // Input Tensor Names
                         1, // Num Input Tensor Names
                         outputs_node_t_8, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode_node_matmul_10(QnnModel& model){
  ...
  uint32_t dimensions_matmul_10[] = {512, 2048};
...
static ModelError_t addNode_node_t_9(QnnModel& model){
  ...
  uint32_t dimensions_t_9[] = {2048, 64};
...
static ModelError_t addNode_node_matmul_11(QnnModel& model){
  ...
  uint32_t dimensions_matmul_11[] = {2048, 512};
...
static ModelError_t addNode_node_matmul_12(QnnModel& model){
  ...
  uint32_t dimensions_matmul_12[] = {512, 512};
...
static ModelError_t addNode_node_mul(QnnModel& model){
  ...
  uint32_t dimensions_mul[] = {512, 512};
...
static ModelError_t addNode_node_sub_1(QnnModel& model){
  ...
  uint32_t dimensions_w_qkv_out[] = {512, 512};
    ...
    (Qnn_Tensor_t) {
          ...
          {.v2= {
            ...
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 2,
            .dimensions=dimensions_w_qkv_out,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
...
static ModelError_t addNode_node_mul_1(QnnModel& model){
  ...
  uint32_t dimensions_mul_1[] = {2048, 512};
...
static ModelError_t addNode_node_sub_2(QnnModel& model){
  ...
  uint32_t dimensions_w_ffn1_out[] = {2048, 512};
    ...
    (Qnn_Tensor_t) {
          ...
          {.v2= {
            ...
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 2,
            .dimensions=dimensions_w_ffn1_out,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
...
static ModelError_t addNode_node_mul_2(QnnModel& model){
  ...
  uint32_t dimensions_mul_2[] = {512, 2048};
...
static ModelError_t addNode_node_sub_3(QnnModel& model){
  ...
  uint32_t dimensions_w_ffn2_out[] = {512, 2048};
    ...
    (Qnn_Tensor_t) {
          ...
          {.v2= {
            ...
            .quantizeParams= { QNN_DEFINITION_UNDEFINED,
                               ...
                               {.scaleOffsetEncoding= {.scale= 0.0000000000000000f, .offset= 0}}},
            .rank= 2,
            .dimensions=dimensions_w_ffn2_out,
            .memType= QNN_TENSORMEMTYPE_RAW,
            {.clientBuf= { .data=nullptr,
                           .dataSize=0}},
            .isDynamicDimensions= nullptr,
...
ModelError_t QnnModel_composeGraphs(Qnn_BackendHandle_t backendHandle,
  ...
  /* model/graph for qnn_monster_full*/
  QnnModel qnn_monster_full;
  const QnnGraph_Config_t** graphConfigs = nullptr;
  VALIDATE(getQnnGraphConfigFromInfo("qnn_monster_full", graphsConfigInfo, numGraphsConfigInfo, graphConfigs), err);
  VALIDATE(qnn_monster_full.initialize(backendHandle, interface, contextHandle, "qnn_monster_full", debug, DO_GRAPH_NODE_VALIDATIONS, graphConfigs), err);
  VALIDATE(addTensor_src(qnn_monster_full), err);
  VALIDATE(addTensor_tgt(qnn_monster_full), err);
  VALIDATE(addTensor_w_qkv(qnn_monster_full), err);
  VALIDATE(addTensor_w_ffn1(qnn_monster_full), err);
  VALIDATE(addTensor_w_ffn2(qnn_monster_full), err);
  VALIDATE(addTensor_lr(qnn_monster_full), err);
  VALIDATE(addNode_node_t(qnn_monster_full), err);
  VALIDATE(addNode_node_matmul(qnn_monster_full), err);
  VALIDATE(addNode_node_t_1(qnn_monster_full), err);
  VALIDATE(addNode_node_matmul_1(qnn_monster_full), err);
  VALIDATE(addTensor_val_0(qnn_monster_full), err);
  VALIDATE(addNode_node_div(qnn_monster_full), err);
  VALIDATE(addNode_node_softmax(qnn_monster_full), err);
  VALIDATE(addNode_node_matmul_2(qnn_monster_full), err);
  VALIDATE(addNode_node_t_2(qnn_monster_full), err);
  VALIDATE(addNode_node_matmul_3(qnn_monster_full), err);
  VALIDATE(addNode_node_relu(qnn_monster_full), err);
  VALIDATE(addNode_node_t_3(qnn_monster_full), err);
  VALIDATE(addNode_node_matmul_4(qnn_monster_full), err);
  VALIDATE(addNode_node_matmul_5(qnn_monster_full), err);
  VALIDATE(addNode_node_t_5(qnn_monster_full), err);
  VALIDATE(addNode_node_matmul_6(qnn_monster_full), err);
  VALIDATE(addNode_node_div_1(qnn_monster_full), err);
  VALIDATE(addNode_node_softmax_1(qnn_monster_full), err);
  VALIDATE(addNode_node_matmul_7(qnn_monster_full), err);
  VALIDATE(addNode_node_matmul_8(qnn_monster_full), err);
  VALIDATE(addNode_node_relu_1(qnn_monster_full), err);
  VALIDATE(addNode_node_matmul_9(qnn_monster_full), err);
  VALIDATE(addNode_node_sub(qnn_monster_full), err);
  VALIDATE(addNode_node_t_8(qnn_monster_full), err);
  VALIDATE(addNode_node_matmul_10(qnn_monster_full), err);
  VALIDATE(addNode_node_t_9(qnn_monster_full), err);
  VALIDATE(addNode_node_matmul_11(qnn_monster_full), err);
  VALIDATE(addNode_node_matmul_12(qnn_monster_full), err);
  VALIDATE(addNode_node_mul(qnn_monster_full), err);
  VALIDATE(addNode_node_sub_1(qnn_monster_full), err);
  VALIDATE(addNode_node_mul_1(qnn_monster_full), err);
  VALIDATE(addNode_node_sub_2(qnn_monster_full), err);
  VALIDATE(addNode_node_mul_2(qnn_monster_full), err);
  VALIDATE(addNode_node_sub_3(qnn_monster_full), err);

  // Add all models to array to get graphsInfo
  QnnModel* models [] = {&qnn_monster_full};
